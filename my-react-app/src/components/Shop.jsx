...
const Shop = () => {
  ...
  const getMeasurement = (value) => {
    return measurementUnit === 'inches' ? `${value}"` : `${convertToCm(value)} cm`;
  };
          ...
          {selectedDressType && (
            <div className="size-outline">
              <div className="size-diagram">
                <div className={`outline-dress type-${selectedDressType} size-${selectedSize.toLowerCase()}`}></div>
                <div className="measurement-lines">
                  <div className="measurement shoulder">Shoulder: {getMeasurement(currentMeasurements.shoulder)}</div>
                  <div className="measurement chest">Chest: {getMeasurement(currentMeasurements.chest)}</div>
                  <div className="measurement waist">Waist: {getMeasurement(currentMeasurements.waist)}</div>
                  <div className="measurement length">Length: {getMeasurement(currentMeasurements.length)}</div>
                </div>
              </div>
              <div className="size-selection">
                <div className="measurement-unit-toggle">
                  <button 
                    className={`unit-btn ${measurementUnit === 'inches' ? 'active' : ''}`}
                    onClick={() => setMeasurementUnit('inches')}
                  >
                    Inches
                  </button>
                  <button 
                    className={`unit-btn ${measurementUnit === 'cm' ? 'active' : ''}`}
